"""
 ...
 Every Python class instance export only public parameters and unserializzation should be in two ways:
	1 - empty class if PhpSerializer file is imported with every public parameter
 ...
 EXAMPLE 1:
	php = PhpSerializer(); // use PhpSerializer(True); to enable UTF8 compatibility
