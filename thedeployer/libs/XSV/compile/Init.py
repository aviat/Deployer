"""Schema compilation: Initialise various component classes,
build some globals
"""

__version__="$Revision: 1.11 $"
# $Id: Init.py,v 1.11 2004-10-04 11:36:47 ht Exp $
...
from XSV.compile import psviIndMap, auxComponentMap
from XSV.compile import builtinTypeNames, builtinPats

from DDummy import DumpedSchema,xpathTemp,namespaceSchemaInformation
from DDummy import valueConstraint, namespaceConstraint, contentType
from DDummy import schemaDocument
...
from Group import Group, ModelGroup
from Group import init as GroupInit
from Wildcard import Wildcard
from Facet import Whitespace
from Facet import Precision, LexicalMappings
from NumFacet import MaxInclusive, MinInclusive, FractionDigits
from ListFacet import Pattern, Enumeration
from ListFacet import init as lfInit
...
# $Log: Init.py,v $
# Revision 1.11  2004-10-04 11:36:47  ht
# token support for pDecimal
#
# Revision 1.10  2004/09/07 17:27:58  ht
# fix bug in _Nmtoken11
#
...
#
# Revision 1.8  2002/12/01 21:54:58  ht
...
#
# Revision 1.6  2002/11/05 14:18:51  ht
# add init for Group
#
# Revision 1.5  2002/09/23 21:31:30  ht
# remove $ from patterns, add list init fn
#
# Revision 1.4  2002/09/23 13:54:58  ht
# install real correct patterns (see lib/unicode/xml2e_classes) for builtins
#
# Revision 1.3  2002/09/02 16:09:25  ht
# minor fixups of udf/uba variety, identified by pychecker
#
# Revision 1.2  2002/08/21 08:53:59  ht
# fix derivation hierarchy for some builtin derived types
#
